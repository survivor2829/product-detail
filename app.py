...
_SCENE_IMG_ALIASES = {
    # 优先顺序：先匹配更长更具体的别名，避免短词误命中
    "地下车库.jpg": ["地下车库", "地下停车", "车库", "停车场", "停车库", "parking", "garage"],
    "火车站.jpg":   ["火车站", "高铁站", "train station", "候车厅", "候车", "交通枢纽", "枢纽", "客运站", "长途客运"],
    "商场.jpg":     ["商场", "购物中心", "购物广场", "商超", "mall", "shopping", "plaza"],
    "酒店大堂.jpg": ["酒店", "hotel", "lobby", "宾馆", "酒店前台"],  # 不含"大堂"，避免"写字楼大堂"误匹配
    "医院.jpg":     ["医院", "诊所", "hospital", "clinic", "医疗", "卫生院", "卫生服务中心"],
